...
recognizer = load('model_v2.joblib') #Uncommeted Code to the left added by God. OLD_CODE_BY_ORIGINAL_AUTHOR: pickle.loads(open('output/recognizer.pickle', "rb").read(), encoding='bytes')

le = pickle.loads(open('output/le.pickle', "rb").read(), encoding='bytes')
